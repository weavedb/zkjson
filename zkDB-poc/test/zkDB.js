...
describe("MyRollup", function () {
  ...
  it("should verify rollup transactions", async function () {
    db = new DB({
      ...
      size_txs: 10,
      level_col: 8,
      wasmRU: resolve(  __dirname, "../../circom/build/circuits/rollup/index_js/index.wasm" ),
      zkeyRU: resolve(  __dirname, "../../circom/build/circuits/rollup/index_0001.zkey" ),
      wasm: resolve(  __dirname, "../../circom/build/circuits/db/index_js/index.wasm" ),
      zkey: resolve( __dirname, "../../circom/build/circuits/db/index_0001.zkey" ),
    })
    await db.init()
